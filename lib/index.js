 ...
 * @property {String} tag - Tag of a given event
 * @property {String} id - ID of a given event
 * @property {String} summary - Summary or title of calendar
 * @property {String} description - Description of calendar (optional)
 * @property {String} timeZone - Timezone of an calendar
 * @property {String} colorId - Color of an calendar (optional)
 */
