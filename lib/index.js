...
class Unical {
    ...
    constructor() {
        ...
        this.calendars = {
            ...
            list: (connectorName, auth, params, options) => {

                return this.callMethod(connectorName, 'listCalendars', auth, params, options);
            }
        };
        ...
        this.events = {
            ...
            list: (connectorName, auth, params, options) => {
                ...
                return this.callMethod(connectorName, 'listEvents', auth, params, options);
            },

            /* Start watching events of a calendar. */
            watch: (connectorName, auth, params, options) => {

                return this.callMethod(connectorName, 'watchEvents', auth, params, options);
            },

            /* Start watching events of a calendar. */
            stopWatch: (connectorName, auth, params, options) => {

                return this.callMethod(connectorName, 'stopWatchEvents', auth, params, options);
            }
        };

        this.auth = {
            refreshCredentialsIfExpired: (connectorName, auth) => {

                return this.callMethod(connectorName, 'refreshAuthCredentials', auth, {}, {});
            },
            revokeCredentials: (connectorName, auth) => {

                return this.callMethod(connectorName, 'revokeAuthCredentials', auth, {}, {});
            }
        };
    }
    ...
    */
     ...
     *
     * @returns {Promise<any>} Returns a unified event list resource when options.raw is false or the raw response of the API when truthy
     */
    callMethod(connectorName, methodName, auth, params, options) {
        ...
        return connector[methodName](auth, params, options);
    }
}
