...
class GoogleConnector extends EventEmitter {
    ...
    watchEvents(auth, params, options, callback) {
        ...
        return this._prepareApiCall({ credentials: auth, oauth: null }, (params, result) => {

            // TODO: in what form does google expect auth params? As a separate object or just regular parameters?
            const googleCalParams = {
                auth: result.credentials,
                ...result.credentials,
                calendarId: params.calendarId,
                requestBody: {
            ...
            GoogleCal.events.watch(googleCalParams, (err, res) => {
